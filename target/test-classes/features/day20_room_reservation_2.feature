...
Feature: User_should_be_able_to_reserve_room
  ...
  Scenario Outline: TC_01_login_with_manager_profile
    ...
    Examples: test data
      ...
      |manager  |Manager2!       |manager       |manager|Krystel|250 |07/01/2021|08/01/2021|1          |0              |My Boss     |(999) 345-6345 |alone@gmail.com|Don't bother       |RoomReservation was inserted successfully  |
      |manager  |Manager3!       |manager        |manager|Karelle|100 |07/01/2021|07/02/2021|2          |1              |My Boss     |(999) 345-6345 |both@gmail.com |one day reservation|RoomReservation was inserted successfully  |